...
The RHEL AI images are tailored for each GPU type. Ensure you are selecting the correct image for your profile. For information regarding the supported use cases for RHEL AI, see [Red Hat Enterprise Linux AI](https://docs.redhat.com/en/documentation/red_hat_enterprise_linux_ai/1.4){: external}.
{: note}
